...
public class BinaryTree {
    ...
    public static void main (String[] args) {
         ...
         *           4   7   9            6   7   9
         */
        labs.lab3.BinaryTree tree1 =
                new labs.lab3.BinaryTree(5,
                        new labs.lab3.BinaryTree(3, null, new labs.lab3.BinaryTree(4)),
                        new labs.lab3.BinaryTree(8, new labs.lab3.BinaryTree(7), new labs.lab3.BinaryTree(9)));
        labs.lab3.BinaryTree tree2 =
                new labs.lab3.BinaryTree(5,
                        new labs.lab3.BinaryTree(3, null, new labs.lab3.BinaryTree(6)),
                        new labs.lab3.BinaryTree(8, new labs.lab3.BinaryTree(7), new labs.lab3.BinaryTree(9)));

        System.out.println("tree1 is a BST? " + tree1.isBinarySearchTree());
        System.out.println("tree2 is a BST? " + tree2.isBinarySearchTree());

        System.out.println("tree1 count: " + tree1.size());
